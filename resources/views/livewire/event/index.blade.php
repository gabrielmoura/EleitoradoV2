                ...
                <table class="table table-striped">
                    ...
                    @foreach($events as $event)
                        <tr>
                            ...
                            <td class="d-flex">
                                <a href="{{route('dash.event.show',['event'=>$event->pid])}}" class="btn btn-black btn-sm m-1">
                                    Ver
                                </a>
                                @can('update_event')
                    ...
                    <form wire:submit.prevent="store">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" wire:model.debounce.500ms="complement" class="form-control">
                                @error('complement') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="mb-3">
                                <label>Bairro</label>
                                <input type="text" wire:model.debounce.500ms="district" class="form-control">
